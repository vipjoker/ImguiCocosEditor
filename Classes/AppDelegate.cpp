...
static cocos2d::Size designResolutionSize = cocos2d::Size(1480, 860);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
#if (CC_TARGET_PLATFORM == CC_PLATFORM_WIN32) || (CC_TARGET_PLATFORM == CC_PLATFORM_MAC) || (CC_TARGET_PLATFORM == CC_PLATFORM_LINUX)
        glview =  IMGUIGLViewImpl::createWithRect("HomeTown", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
//        glview =  IMGUIGLViewImpl::createWithFullScreen("HomeTown");
...
#else
        glview = GLViewImpl::create("ClionCocos");
#endif
